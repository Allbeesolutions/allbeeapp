...
export function APNPortal({ db, profile, session, signOut, isDark, mutate, patchDb = () => {}, reload }) {
  ...
  const section = () => {
    switch (tab) {
      ...
      case "wallet": return <React.Suspense fallback={<div className="content"><div className="card" aria-busy="true">Loading wallet…</div></div>}> <LazyAPNWallet db={db} pid={pid} stats={stats} snap={finSnap} runtime={{ ...Icons, APNMetric, APNWalletDetailModal: LazyAPNWalletDetailModal, APN_COMM_REVERSED, APN_WITHDRAWAL_TYPES, Empty, apnCommTone, apnCommissionProjectsOf, apnCommsOf, apnPayoutDate, apnProjectSummary, apnRequestAmount, apnRevenueCollectionsOf, apnSnapshotWallet, apnWalletLabel, apnWithdrawalLabel, apnWithdrawalTone, apnWithdrawalWalletFor, fmtDate, fmtDateTime, money }} />;</React.Suspense>;
