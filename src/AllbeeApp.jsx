...
// ── load data + live sync while signed in ─────────────────────────────
  ...
  const renderPage = () => {
    ...
    switch (safeRoute) {
      ...
      case "vault": return <React.Suspense fallback={<div className="content"><div className="card" aria-busy="true">Loading vault…</div></div>}> <LazyVault db={db} mutate={mutate} openModal={openModal} removeItem={removeItem} runtime={{ Empty, money, uid, QUOTE_STATUS, VAULT_CATEGORIES, fmtDate, avatarColor }} />;</React.Suspense>;
