...
export function createDataReaders({ supabase, emptyDB, loadTableRows }) {
  ...
  const TABLE_FETCH_LIMITS = Object.freeze({
    ...
    apn_users: 1000, apn_attendance: 1500, apn_targets: 1000, apn_training: 500, apn_quizzes: 500,
    apn_leads: 1500, apn_quotations: 1000, apn_commissions: 2000, apn_commission_projects: 1500,
    apn_revenue_collections: 1500, apn_achievements: 1000, apn_notifications: 500, apn_documents: 500,
    apn_transfer_history: 500, apn_admin_consoles: 300, apn_zone_requests: 500,
